...
const TESTIMONIAL_PANELS = [
  {
    ...
    quote:
      "fitur AI Scanner langsung memberikan klasifikasi grade otomatis serta asisten AI 24/7 yang membantu pencegahan wabah penyakit ternak ayam kami.",
    author: "Slamet Widodo",
    role: "Peternak Ayam Broiler di Subang",
    maskType: "none",
    // STANDARDIZED TOP-LEFT SPOT POSITIONING:
    containerAlign:
      "justify-start items-start pt-16 sm:pt-20 md:pt-24 pl-4 sm:pl-8 md:pl-12",
    maxWidth:
      "max-w-lg sm:max-w-xl md:max-w-2xl",
    bubbleAlign: "items-end",
    textAlign: "text-right",
    tailPosition:
      "after:right-8 sm:after:right-12",
    authorAlign:
      "items-end text-right pr-2 sm:pr-4",
    topGradient: true,
  ...
  },
  {
    ...
    quote:
      "saya bisa langsung membuka toko ternak terverifikasi, memasang acuan harga transparan per kg, dan menjual daging sapi tanpa perantara.",
  ...
  },
  {
    ...
    quote:
      "jadwal pakan harian tercatat di kalender interaktif, stok susu terhubung otomatis ke toko, dan pesanan masuk dapat dipantau dalam satu dasbor.",
    author: "Mulyono",
    role: "Peternak Sapi Perah di Lembang",
    maskType: "inset",
    // STANDARDIZED TOP-RIGHT SPOT POSITIONING (MIRRORED INNER ALIGNMENT):
    containerAlign:
      "justify-start items-end pt-16 sm:pt-20 md:pt-24 pr-4 sm:pr-8 md:pr-12",
    maxWidth:
      "max-w-lg sm:max-w-xl md:max-w-2xl",
    bubbleAlign: "items-start",
    textAlign: "text-left",
    tailPosition:
      "after:left-8 sm:after:left-12",
    authorAlign:
      "items-start text-left pl-2 sm:pl-4",
    topGradient: false,
    bottomGradient: true,
  },
];
  ...
  return (
    ...
    >
      ...
      <div className="px-5 mb-6 text-center flex flex-col items-center">
        <span
          className={cn(
            "inline-block bg-[#405D46] text-emerald-100",
        ...
        <h2
          className={cn(
            "text-2xl font-bold font-rustic",
        ...
        <p
          className={cn(
            "text-xs text-emerald-100/80 mt-1",
            "max-w-xs leading-relaxed",
          )}
        >
          Geser untuk melihat testimoni
          pengguna Pranata di berbagai
          daerah.
        </p>
      </div>
      ...
      >
        {TESTIMONIAL_PANELS.map(
          (panel, i) => (
            <div
              key={`mobile-card-${panel.id}`}
              className={cn(
                "shrink-0 w-[85vw] max-w-xs",
                "h-[450px] rounded-[2rem] overflow-hidden",
                "relative shadow-2xl border",
                "border-white/20 snap-center flex",
            ...
            >
              ...
              <div
                className={cn(
                  ...
                  "from-[#1C241E]/95 via-[#1C241E]/40 to-transparent",
                  "pointer-events-none",
                )}
              />
              ...
              <div className="relative z-10 flex justify-between items-center">
                <span
                  className={cn(
                    "inline-flex items-center bg-white/95",
                ...
                <span
                  className={cn(
                    "text-white/80 text-[11px] font-black",
                    "tracking-widest",
                  )}
                >
                  0{panel.id} / 03
              ...
              <div className="relative z-10 flex flex-col gap-3">
                ...
                <div
                  className={cn(
                    ...
                    "border border-white/80 p-4",
                    "rounded-2xl shadow-xl relative",
                    "text-left after:content-[''] after:absolute",
                    "after:top-full after:left-6 after:border-x-[10px]",
                    "after:border-t-[12px] after:border-x-transparent after:border-b-transparent",
                    "after:border-t-white/95",
                  )}
                >
                  <p
                    className={cn(
                      "text-xs font-semibold text-[#1C241E]",
                      "leading-relaxed",
                    )}
                    style={{
                      fontFamily:
                ...
                <div className="flex flex-col pt-1 pl-1">
                  <h3
                    className={cn(
                      ...
                      "tracking-wider uppercase drop-shadow-md",
                    )}
                  >
                    {panel.author}
                  </h3>
                  <p
                    className={cn(
                      "text-emerald-300 font-medium text-[11px]",
                      "drop-shadow-sm",
                    )}
                  >
                    {panel.role}
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "w-full bg-[#32452C] editorial-gallery-container",
        "overflow-hidden transform-gpu -mt-2",
      )}
        ...
        (item, index) => {
          ...
          return (
            <div
              ...
              className={cn(
                "panel absolute inset-0",
                "w-full h-full bg-[#32452C]",
            ...
            >
              ...
              <div
                className={cn(
                  ...
                  "parallax-img opacity-100 transform-gpu",
                )}
              >
                <img
                  src={item.image}
              ...
              {item.topGradient && (
                <div
                  className={cn(
                    ...
                    "right-0 z-10 bg-linear-to-b",
                    "from-[#32452C] via-[#32452C] via-15%",
                    "to-transparent w-full h-48",
                    "sm:h-64 md:h-80 pointer-events-none",
                  )}
                />
              )}
              ...
              {item.bottomGradient && (
                <div
                  className={cn(
                    ...
                    "right-0 z-10 bg-linear-to-t",
                    "from-[#32452C] via-[#32452C] via-15%",
                    "to-transparent w-full h-64",
                    "sm:h-96 md:h-[500px] pointer-events-none",
                  )}
                />
              )}
              ...
              {/* Panel Content */}
              <div
                className={`panel-content absolute inset-0 z-20 flex flex-col p-4 sm:p-8 md:p-20 ${item.containerAlign}`}
              >
                <div
                  className={`${item.maxWidth} w-full flex flex-col ${item.bubbleAlign}`}
                >
                  {/* Speech Bubble */}
                  <div
                  ...
                  >
                    <h2
                      className={cn(
                        ...
                        "font-bold font-rustic text-transparent",
                        "bg-clip-text bg-linear-to-r from-[#1C241E]",
                        "via-[#32452C] to-[#2B4C3B] leading-[1.4]",
                        "tracking-wide",
                      )}
                      style={{
                        fontFamily:
                    ...
                    >
                      ...
                      <img
                        ...
                        alt={item.title}
                        className={cn(
                          "inline-block h-4 sm:h-5",
                          "md:h-6 w-auto align-middle",
                          "mx-1 object-contain -translate-y-0.5",
                          "sm:-translate-y-1 relative",
                        )}
                        decoding="async"
                      />
                      , {item.quote}&quot;
                  ...
                  {/* Author */}
                  <div
                    className={`flex flex-col gap-0.5 ${item.authorAlign}`}
                  >
                    <p
                      className={cn(
                        "text-white font-black tracking-wider",
                        "uppercase text-xs sm:text-sm",
                        "md:text-base [text-shadow:0_2px_4px_#000,0_4px_12px_#000,0_8px_20px_rgba(0,0,0,0.95)]",
                      )}
                    >
                      {item.author}
                    </p>
                    <p
                      className={cn(
                        "text-emerald-100 font-semibold text-[11px]",
                        "sm:text-xs md:text-sm [text-shadow:0_2px_4px_#000,0_4px_12px_#000]",
                      )}
                    >
                      {item.role}
                    </p>
...
export function EditorialGallery() {
  ...
  return isMobile ? (
    <MobileTestimoniCarousel />
  ) : (
    <DesktopEditorialGallery />
  );
}
