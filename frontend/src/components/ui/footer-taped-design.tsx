...
export function FooterTapedDesign() {
  ...
  return (
    <footer className="w-full bg-[#32452C] text-[#E8E3D2] pt-12 pb-8 px-4 sm:px-6 lg:px-8 relative z-20 overflow-hidden">
      {/* Taped Card Container */}
      <div className="relative bg-[#263722] border border-white/10 rounded-3xl max-w-6xl mx-auto px-6 sm:px-10 py-10 sm:py-12 flex flex-col md:flex-row justify-between items-center gap-8 shadow-2xl">
        {/* Tape Accent Left */}
        <div className="hidden md:block absolute -top-4 -left-8 w-[80px] h-[36px] scale-75 select-none pointer-events-none drop-shadow-md">
          {tape}
        </div>
        {/* Tape Accent Right */}
        <div className="hidden md:block absolute -top-4 -right-8 rotate-90 w-[80px] h-[36px] scale-75 select-none pointer-events-none drop-shadow-md">
          {tape}
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-start justify-between gap-8 lg:gap-12 w-full">
          ...
          <div className="flex flex-col items-start gap-4 lg:w-5/12">
            ...
            <p className="text-emerald-100/75 font-medium text-xs sm:text-sm leading-relaxed max-w-md">
            ...
            {/* Status & Non-Profit Badges */}
            <div className="flex flex-wrap items-center gap-2 pt-1">
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-extrabold bg-[#1C2819] text-[#B4C179] border border-[#8FA76B]/30">
                <ShieldCheck size={13} />
                <span>Nirlaba & Gratis</span>
              </span>
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-extrabold bg-emerald-950/80 text-emerald-300 border border-emerald-500/30">
          ...
          {/* Links Grid */}
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-6 sm:gap-8 lg:w-7/12">
            {/* Column 1: Ekosistem Modul */}
            <div className="flex flex-col gap-3">
              <h4 className="uppercase font-extrabold text-xs tracking-wider text-[#B4C179] flex items-center gap-1.5">
                <Cpu size={14} />
                <span>Modul AI</span>
              </h4>
              <div className="flex flex-col gap-2 text-xs font-semibold text-emerald-100/80">
                <Link href="/hub/intelligence" className="hover:text-[#B4C179] transition-colors">
                  Pranata Intelligence
                </Link>
                <Link href="/market" className="hover:text-[#B4C179] transition-colors">
                  Pranata Market
                </Link>
                <Link href="/hub" className="hover:text-[#B4C179] transition-colors">
                  Pranata Hub
                </Link>
            ...
            <div className="flex flex-col gap-3">
              <h4 className="uppercase font-extrabold text-xs tracking-wider text-[#F5990D] flex items-center gap-1.5">
                <Store size={14} />
                <span>Navigasi</span>
              </h4>
              <div className="flex flex-col gap-2 text-xs font-semibold text-emerald-100/80">
            ...
            {/* Column 3: Dukungan */}
            <div className="flex flex-col gap-3">
              <h4 className="uppercase font-extrabold text-xs tracking-wider text-[#8FA76B] flex items-center gap-1.5">
                <Globe size={14} />
                <span>Dukungan</span>
              </h4>
              <div className="flex flex-col gap-2 text-xs font-semibold text-emerald-100/80">
      ...
      {/* Footer Bottom Bar */}
      <div className="max-w-6xl mx-auto mt-6 px-2 sm:px-4 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs font-semibold text-emerald-100/70">
        <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2 text-center sm:text-left">
          <span>© {currentYear} Pranata Org. Dipersembahkan dengan</span>
        ...
        <div className="flex items-center gap-5">
          <a
            ...
            aria-label="LinkedIn Pranata"
            className="hover:text-[#B4C179] transition-colors"
          >
          ...
          <button
            ...
            className="flex items-center gap-1.5 bg-[#263722] hover:bg-[#1C2819] active:scale-95 text-[#E8E3D2] px-3.5 py-1.5 rounded-full border border-white/15 transition-all cursor-pointer shadow-xs text-[11px] font-extrabold ml-2"
            aria-label="Ke Atas"
          >
            <span>Ke Atas</span>
            <ArrowUp size={12} />
