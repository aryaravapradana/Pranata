...
export function FooterTapedDesign() {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "relative bg-[#263722] border",
          "border-white/10 rounded-3xl max-w-6xl",
          "mx-auto px-6 sm:px-10",
          "py-10 sm:py-12 flex",
          "flex-col md:flex-row justify-between",
          "items-center gap-8 shadow-2xl",
        )}
      >
        {/* Tape Accent Left */}
        <div
        ...
        <div
          className={cn(
            "hidden md:block absolute",
            "-top-4 -right-8 rotate-90",
            "w-[80px] h-[36px] scale-75",
        ...
        >
          ...
          <div className="flex flex-col items-start gap-4 lg:w-5/12">
            ...
            <p
              className={cn(
                "text-emerald-100/75 font-medium text-xs",
                "sm:text-sm leading-relaxed max-w-md",
              )}
            >
              Pranata adalah inisiatif
              digitalisasi sektor peternakan
              berbasis AI dan integrasi
              rantai pasok pasar transparan
              untuk memberdayakan peternak
            ...
            <div className="flex flex-wrap items-center gap-2 pt-1">
              <span
                className={cn(
                  ...
                  "text-[11px] font-extrabold bg-[#1C2819]",
                  "text-[#B4C179] border border-[#8FA76B]/30",
                )}
              >
                <ShieldCheck size={13} />
              ...
              <span
                className={cn(
                  "inline-flex items-center gap-1.5",
                  "px-3 py-1 rounded-full",
                  "text-[11px] font-extrabold bg-emerald-950/80",
          ...
          >
            ...
            <div className="flex flex-col gap-3">
              <h4
                className={cn(
                  ...
                  "tracking-wider text-[#B4C179] flex",
            ...
            <div className="flex flex-col gap-3">
              <h4
                className={cn(
                  "uppercase font-extrabold text-xs",
                  "tracking-wider text-[#F5990D] flex",
                  "items-center gap-1.5",
                )}
              >
                <Store size={14} />
            ...
            <div className="flex flex-col gap-3">
              <h4
                className={cn(
                  "uppercase font-extrabold text-xs",
                  "tracking-wider text-[#8FA76B] flex",
                  "items-center gap-1.5",
                )}
              >
                <Globe size={14} />
              ...
              >
                ...
                <a
                  href="mailto:support@pranata.org"
                  className="hover:text-white transition-colors"
                >
                  Kontak Bantuan
                </a>
      ...
      <div
        className={cn(
          ...
          "font-semibold text-emerald-100/70",
        )}
      >
        <div
          className={cn(
            "flex flex-wrap items-center",
            "justify-center sm:justify-start gap-2",
            "text-center sm:text-left",
          )}
        >
          <span>
            © {currentYear} Pranata Org.
            Dipersembahkan dengan
          </span>
          <Heart
            size={13}
            className="text-[#C25939] fill-[#C25939] inline"
          />
          <span>
            untuk Peternak Indonesia.
          </span>
        </div>
        ...
        <div className="flex items-center gap-5">
          ...
          <button
            ...
            className={cn(
              ...
              "bg-[#263722] hover:bg-[#1C2819] active:scale-95",
              "text-[#E8E3D2] px-3.5 py-1.5",
              "rounded-full border border-white/15",
              "transition-all cursor-pointer shadow-xs",
              "text-[11px] font-extrabold ml-2",
            )}
            aria-label="Ke Atas"
          >
            <span>Ke Atas</span>
