    ...
    >
      ...
      <div
        className={cn(
          ...
          "top-0 right-0 w-96",
          "h-96 bg-[#E8E3D2]/50 rounded-full",
          "blur-3xl pointer-events-none -translate-y-1/3",
          "translate-x-1/3",
        )}
      />
      <div
        className={cn(
          "hidden sm:block absolute",
          "bottom-0 left-0 w-96",
          "h-96 bg-[#DDE2D6]/60 rounded-full",
          "blur-3xl pointer-events-none translate-y-1/3",
          "-translate-x-1/3",
        )}
      />
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="flex flex-col items-center text-center mb-6">
          ...
          <p className="text-[#5A635B] text-xs sm:text-sm font-semibold">
            {authMode === "login"
              ? "Masuk ke Akun Peternakan & Pasar Anda"
              : "Buat Akun Pranata Baru"}
          </p>
        </div>
        ...
        <div
          className={cn(
            "bg-[#EAE6D8] p-1.5 rounded-full",
            "flex items-center justify-between",
            "mb-6 shadow-inner border",
            "border-[#DDD8C8]",
          )}
        >
          <button
          ...
          {authMode === "login" ? (
            <motion.div
              ...
              className={cn(
                ...
                "border-[#DDE2D6] p-7 sm:p-9",
                "rounded-[2.5rem] shadow-[0_20px_40px_-10px_rgba(43,76,59,0.08)]",
              )}
            >
              {error && (
                <div
