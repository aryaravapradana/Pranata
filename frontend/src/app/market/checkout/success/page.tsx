    ...
    >
      <motion.div
        ...
        className={cn(
          ...
          "md:p-14 max-w-lg w-full",
          "text-center shadow-[0_20px_60px_-15px_rgba(43,76,59,0.15)] border",
          "border-[#E8E3D2] relative z-10",
        )}
      >
        <motion.div
          initial={{ scale: 0 }}
        ...
        <h1 className="text-3xl font-black text-[#1C241E] mb-3">
          Yey! Pembayaran Berhasil
        </h1>
        <p
          className={cn(
            "text-[#5A635B] font-medium text-sm",
            "mb-8 leading-relaxed",
          )}
        >
          Pesanan kamu telah kami terima dan
          sedang diteruskan ke pihak
          pedagang. Siap-siap menunggu
          kedatangan hasil tani terbaik ya!
        </p>
