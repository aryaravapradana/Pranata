      ...
      >
        ...
        <div className="flex flex-col items-start flex-1 w-full text-left">
          <div className="flex flex-wrap items-center gap-1 mb-2">
            <div
              className={`px-1.5 py-0.5 rounded-md ${cartQty > 0 ? "bg-white/10" : "bg-[#F8F6F0]"}`}
            >
              <span
            ...
            {(p.category || "").toLowerCase() === "daging" &&
              ...
              (() => {
                ...
                return (
                  <span
                    className={`${style.bg} ${style.text} border ${style.border} px-1.5 py-0.5 rounded-md text-[9px] sm:text-[10px] font-black uppercase tracking-wider flex items-center gap-1 shadow-xs ${cartQty > 0 ? "opacity-90" : ""}`}
                  >
                    <GradeIcon
                      size={9}
                      className={
          ...
          <div
            className={`mt-auto w-full pt-2 border-t flex items-end justify-between ${cartQty > 0 ? "border-white/20" : "border-[#E8E3D2]/50"}`}
          >
            <div>
              <p
                className={`text-sm sm:text-lg font-black leading-none mb-0.5 ${cartQty > 0 ? "text-white" : "text-[#C25939]"}`}
              >
                Rp{" "}
        ...
        {p.stock > 0 ? (
          cartQty > 0 ? (
            ...
            >
              ...
              <button
                ...
                className={`p-1 rounded-md transition-colors ${cartQty >= p.stock ? "opacity-50 pointer-events-none" : "hover:bg-white/20"}`}
              >
                <Plus
                  size={15}
                  strokeWidth={3}
            ...
            <button
              ...
              className={cn(
                "mt-3 sm:mt-5 w-full",
                "bg-[#EEF2E6] hover:bg-[#DDE2D6] text-[#2B4C3B]",
          ...
          <div
            className={cn(
              "mt-3 sm:mt-5 w-full",
              "bg-gray-100 text-gray-400 py-2.5",
    ...
    >
      <button
        ...
        className={cn(
          ...
          "hover:bg-[#F8F6F0] transition-all shadow-sm",
          "shrink-0",
        )}
      >
        <div className="flex items-center gap-1.5 sm:gap-2">
          <Icon
            size={14}
            className="text-[#32452C] shrink-0"
          />
...
function MarketplaceProductsContent() {
  ...
  const filteredProducts = useMemo(() => {
    const filtered = products.filter((p) => {
      ...
      return (
        matchCat && matchSearch && matchGrade
      );
    });
  ...
  return (
    <div
      className={cn(
        ...
        "overflow-x-clip font-sans selection:bg-[#B4C179]",
      )}
    >
      {/* Sticky White Navbar */}
      ...
      >
        ...
        <div
          className={cn(
            ...
            "p-2.5 sm:p-2 sm:pl-6",
            "shadow-sm border border-[#E8E3D2]",
            "flex flex-col md:flex-row",
            "items-stretch md:items-center gap-3",
          )}
        >
          ...
          <div
            className={cn(
              ...
              "sm:px-0 py-1 sm:py-0",
              "bg-[#F8F6F0] md:bg-transparent rounded-2xl",
              "md:rounded-none",
            )}
          >
            <Search
              className="text-[#A4B0A7] shrink-0"
              size={16}
            />
            <input
              type="text"
              ...
              className={cn(
                "w-full md:w-64 bg-transparent",
                "outline-none text-[#1C241E] placeholder:text-[#A4B0A7]",
          ...
          <div
            className={cn(
              "w-full md:flex-1 overflow-x-auto",
              ...
              {CATEGORIES.map((cat) => (
                <button
                  ...
                  onClick={() => {
                    ...
                    router.replace(
                      `/market/products?category=${encodeURIComponent(cat.name)}`,
                    );
                  }}
        ...
        {loading ? (
          ...
          <div
            className={cn(
              "text-center py-20 border-2",
              "border-dashed border-[#E8E3D2] rounded-3xl",
          ...
          >
            <Package
              size={44}
              className="mx-auto text-[#C4BAA8] mb-3"
            />
            <h3 className="text-lg font-black text-[#5A635B] mb-1">
              ...
              >
                ...
                <div className="flex items-center gap-1.5">
                  <button
                    ...
                    className={cn(
                      "w-9 h-9 rounded-2xl",
                      "bg-[#F8F6F0] hover:bg-[#E8E3D2] text-[#1C241E]",
