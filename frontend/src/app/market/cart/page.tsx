...
function ActivityContent() {
    ...
    const fetchData = async () => {
      ...
      try {
        const res = await fetchApi(
          `${API_BASE}/api/orders/BUYER/${session.id}`,
        );
        if (res.ok) {
  ...
  const removeItem = async (id: string) => {
    ...
    try {
      if (profile) {
        await fetchApi(
          `${API_BASE}/api/cart/${profile.id}/${itemToRemove.productId}`,
          {
            method: "DELETE",
          },
        );
  ...
  if (loading)
    return (
      <div className="min-h-screen bg-[#F8F6F0] text-[#1C241E]">
        ...
        <main
          className={cn(
            "max-w-7xl mx-auto pt-12",
            "md:pt-16 px-4 md:px-8",
            "lg:px-12",
          )}
        >
          <div
          ...
          <div
            className={cn(
              "w-64 h-4 rounded-md",
              "skeleton-shimmer bg-[#E8E3D2] mb-12",
            )}
          />
        ...
        centerContent={
          <div
            className={cn(
              ...
              "sm:gap-1 relative shadow-inner",
        ...
        <AnimatePresence mode="wait">
          {activeTab === "cart" ? (
            ...
            >
              <h1
                className={cn(
                  "text-2xl sm:text-4xl md:text-[3.5rem]",
                  "font-black tracking-tight text-[#1C241E]",
                  "mb-4 sm:mb-6",
                )}
              >
                Keranjang
              ...
              <div
                className={cn(
                  ...
                  "sm:gap-4 text-xs sm:text-sm",
                  "font-bold text-[#1C241E] mb-8",
                  "sm:mb-12 overflow-x-auto hide-scrollbar",
                )}
              >
                <span className="text-[#1C241E] shrink-0">
                  1. Keranjang
                </span>
                <div className="w-6 sm:w-16 h-px bg-[#DDE2D6] shrink-0"></div>
                <span className="text-[#A4B0A7] font-semibold shrink-0">
                  2. Checkout
                </span>
                <div className="w-6 sm:w-16 h-px bg-[#DDE2D6] shrink-0"></div>
                <span className="text-[#A4B0A7] font-semibold shrink-0">
              ...
              {cart.length === 0 ? (
                <div
                  className={cn(
                    ...
                    "border-2 border-dashed border-[#DDE2D6]",
                    "rounded-[2rem] bg-white max-w-7xl",
                    "mx-auto px-4 md:px-8",
                    "lg:px-12",
                  )}
                >
                  <h3 className="text-lg sm:text-xl font-black text-[#5A635B] mb-2">
                    Keranjang Kosong
                  </h3>
                  <p
                    className={cn(
                      "text-[#A4B0A7] text-xs sm:text-sm",
                      "font-medium mb-6",
                    )}
                  >
                ...
                >
                      ...
                      >
                        ...
                        >
                          ...
                          item.product
                            ...
                            <Package
                              className="text-[#C4BAA8] opacity-60"
                              size={40}
                            />
                          )}
                        </div>
                        <div className="flex flex-col flex-1">
                          ...
                          >
                            <div>
                              <h3
                                className={cn(
                                  "text-[22px] font-bold text-[#1C241E]",
                                  "mb-1 leading-tight tracking-tight",
                                )}
                              >
                                {
                                  item
                              ...
                              <p
                                className={cn(
                                  "text-[13px] font-semibold text-[#5A635B]",
                                  "mb-3 line-clamp-1",
                                )}
                              >
                                {item.product
                                  ?.description ||
                                  "Produk Pilihan Pranata"}
                              </p>
                              <div
                                className={cn(
                                  "flex items-center gap-2",
                                  "text-[13px] font-bold text-[#A4B0A7]",
                                )}
                              >
                                <span>
                                  Kategori{" "}
                          ...
                          <div className="mt-4 flex items-center gap-3">
                            <span className="text-[22px] font-bold text-[#1C241E]">
                              Rp{" "}
                              {(
                                item.product
                                  ?.price ||
                          ...
                          <div className="flex items-center justify-between mt-6">
                            ...
                            >
                              <button
                                ...
                                className={cn(
                                  ...
                                  "hover:text-[#2B4C3B] hover:bg-[#EEF2E6] active:scale-95",
                                  "rounded-lg transition-all font-bold",
                                )}
                              >
                                -
                              </button>
                            ...
                            <div className="flex items-center gap-3">
                              <span className="text-xs font-bold text-[#A4B0A7]">
                                Stok
                                Tersedia:{" "}
                                {
                                  item
                              ...
                              <button
                                ...
                                className={cn(
                                  "w-10 h-10 flex",
                                  "items-center justify-center text-[#A4B0A7]",
                                  "hover:text-[#C25939] hover:bg-red-50 border",
                                  "border-[#E8E3D2] bg-white rounded-xl",
                  ...
                  <div
                    className={cn(
                      "bg-[#F1EBE1] rounded-[2rem] p-8",
                      "shadow-[0_8px_32px_-16px_rgba(43,76,59,0.15)] sticky top-28",
                    )}
                  >
                    <h2 className="text-xl font-bold text-[#1C241E] mb-8">
                      Ringkasan Pesanan
                    </h2>
                    ...
                    <div className="space-y-5 text-sm font-semibold mb-6">
                      <div className="flex justify-between items-center text-[#5A635B]">
                        ...
                        <span className="text-[#1C241E] font-bold text-[15px]">
                          Rp{" "}
                      ...
                      <div className="flex justify-between items-center text-[#5A635B]">
                        ...
                        <span className="text-[#C25939] font-bold text-[15px]">
                          Gratis
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="flex justify-between items-center mb-8">
                      <span className="text-[#1C241E] font-bold">
                        Total Keseluruhan
                      </span>
                      <span className="text-[22px] font-bold text-[#2B4C3B]">
                        Rp{" "}
            ...
            >
              <h1
                className={cn(
                  "text-4xl md:text-[3.5rem] font-black",
                  "tracking-tight text-[#1C241E] mb-10",
                )}
              >
                Pesanan Saya
              </h1>
              ...
              {orders.length === 0 ? (
                <div
                  className={cn(
                    ...
                    "shadow-[0_4px_24px_-8px_rgba(43,76,59,0.08)] mt-10",
                  )}
                >
                  <div
                    className={cn(
                  ...
                  {orders.map((o) => (
                    ...
                    >
                      ...
                      >
                        ...
                        <span
                          className={`text-[10px] font-black px-3 py-1.5 rounded-full uppercase tracking-wide flex items-center gap-1.5 ${STATUS_COLORS[o.status]}`}
                        >
                          {o.status ===
                            "PENDING" && (
                            <Clock
