...
export default function SellerProfilePage({
  ...
  const loadData = async (
    ...
    setGridLoading(true);
    try {
      const [sellerRes, prodRes] =
        await Promise.all([
          fetchApi(
            `${API_BASE}/api/profile/${sellerId}`,
          ),
          fetchApi(
            `${API_BASE}/api/products/seller/${sellerId}?page=${pageToLoad}&limit=${LIMIT}`,
          ),
        ]);
      if (sellerRes.ok)
      ...
      <div className="min-h-screen bg-[#F8F6F0] text-[#1C241E]">
        ...
        <div
          className={cn(
            ...
            "mx-auto pt-4 sm:pt-6",
            "pb-16 sm:pb-24 space-y-6",
        ...
        >
          <div
            className={cn(
              ...
              "shadow-[0_8px_32px_-12px_rgba(43,76,59,0.14)]",
            )}
          >
            <div
              className={cn(
            ...
            <div className="px-4 sm:px-8 pb-5 sm:pb-7">
              ...
              <div className="flex gap-2">
                <div
                  className={cn(
                    "w-28 sm:w-32 h-7",
                    "sm:h-8 rounded-full skeleton-shimmer",
                    "bg-[#E8E3D2]",
                  )}
                />
                <div
    ...
    return (
      <div
        className={cn(
          ...
          "justify-center bg-[#F8F6F0] p-4",
        )}
      >
        <div className="text-center">
          <Store
            size={48}
            className="mx-auto text-[#C4BAA8] mb-3 sm:w-14 sm:h-14"
          />
          <p className="font-black text-lg sm:text-xl text-[#5A635B]">
      ...
      >
        <div>
          <button
            ...
            className={cn(
              ...
              "border-[#E8E3D2] hover:bg-[#F8F6F0] text-[#1C241E]",
        ...
        >
          ...
          <div
            className={cn(
              "relative h-32 sm:h-40",
              "md:h-52 bg-pranata overflow-hidden",
            )}
          >
            {seller.bannerUrl ? (
              <img
          ...
          <div className="px-4 sm:px-8 pb-5 sm:pb-7">
            ...
            <div className="flex items-center gap-2 flex-wrap mb-1">
              ...
              <span
                className={cn(
                  ...
                  "sm:gap-1.5 bg-[#EEF2E6] text-[#2B4C3B]",
                  "text-[10px] sm:text-xs font-black",
                  "px-2.5 py-1 sm:px-3",
                  "sm:py-1.5 rounded-full",
                )}
              >
                <ShieldCheck
                  size={11}
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              <span
                className={cn(
                  "inline-flex items-center gap-1.5",
                  "bg-[#F8F6F0] border border-[#E8E3D2]",
                  "text-[#5A635B] text-xs sm:text-sm",
              ...
              {seller.contact && (
                ...
                >
                  <Phone
                    size={12}
                    className="text-[#2B4C3B] shrink-0"
                  />
                  <span>
                    {seller.contact}
                  </span>
        ...
        >
          <div className="mb-4 sm:mb-6">
            <h2 className="text-xl sm:text-2xl font-black text-[#1C241E]">
              Etalase Produk
            </h2>
          </div>
          ...
          {gridLoading ? (
            ...
            >
              <Package
                size={40}
                className="mx-auto text-[#C4BAA8] mb-3 sm:w-12 sm:h-12"
              />
              <p className="font-black text-lg sm:text-xl text-[#5A635B] mb-1">
                Belum ada produk
              </p>
              <p className="text-xs sm:text-sm text-[#A4B0A7] font-medium">
                Penjual ini belum menambahkan
                produk.
              </p>
            </div>
          ) : (
              ...
              {products.map((p, i) => (
                <motion.div
                  ...
                  className={`bg-white border border-[#E8E3D2] rounded-2xl sm:rounded-[1.75rem] overflow-hidden group will-change-transform transition-all duration-200 ${
                    p.stock > 0
                      ? "cursor-pointer hover:-translate-y-1 hover:shadow-[0_24px_48px_-12px_rgba(43,76,59,0.18)] active:scale-98"
                ...
                >
                  ...
                  <div
                    className={cn(
                      "h-44 sm:h-52 w-full",
                      "bg-[#F1EBE1] overflow-hidden relative",
                    )}
                  >
                    {p.imageUrls &&
                    p.imageUrls.length >
                    ...
                    {p.category && (
                      <div
                        className={cn(
                          ...
                          "sm:top-3 sm:left-3 bg-white",
                          "text-[#2B4C3B] text-[10px] sm:text-[11px]",
                          "font-black px-2.5 py-1",
                          "sm:px-3 sm:py-1.5 rounded-full",
                  ...
                  <div className="p-4 sm:p-5">
                    <h3
                      className={cn(
                        ...
                        "text-[#1C241E] truncate group-hover:text-[#2B4C3B]",
                    ...
                    <div className="flex items-end justify-between mt-2.5 sm:mt-3">
                      <div>
                        ...
                        <p
                          className={cn(
                            "text-[10px] sm:text-[11px] text-[#7A8678]",
                      ...
                      <span
                        className={`text-[10px] sm:text-[11px] font-black px-2 py-1 sm:px-2.5 sm:py-1.5 rounded-lg sm:rounded-xl ${
                          p.stock > 0
