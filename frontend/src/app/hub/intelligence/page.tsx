  ...
  useEffect(() => {
    ...
    if (saved) {
      try {
        ...
        console.error(
          "Failed to parse saved chat history",
          e,
        );
      }
    }
  ...
  const handleConfirmClear = () => {
    ...
    if (sessionStr) {
      ...
      localStorage.removeItem(
        `pranata_chat_history_${session.id || "default"}`,
      );
    }
  ...
  return (
    <div
      className={cn(
        ...
        "selection:bg-[#2B4C3B] selection:text-white relative",
      )}
    >
          ...
          {messages.length > 0 && (
            ...
            >
              <img
                ...
                className={cn(
                  "h-6 sm:h-7 w-auto",
                  "object-contain drop-shadow-sm pointer-events-auto",
                )}
              />
            </div>
          )}
            ...
            <AnimatePresence initial={false}>
              {messages.map((m) => (
                ...
                >
                  {m.role ===
                    ...
                    <div
                      className={cn(
                        ...
                        "bg-white border border-[#E8E3D2]",
                        "p-1.5 flex items-center",
                        "justify-center shadow-sm overflow-hidden",
                        "sticky top-20 z-10",
                      )}
                    >
                      <img
                  ...
                  <div
                    className={`max-w-[85%] sm:max-w-[78%] rounded-[2rem] p-4 sm:p-5 shadow-sm ${
                      m.role === "user"
                  ...
                  >
                    ...
                    "assistant" ? (
                      ...
                      <div
                        className={cn(
                          "text-[10px] sm:text-[11px] font-black",
                          "text-[#C8E6C9] uppercase tracking-wider",
                          "mb-2 text-right",
                        )}
                      >
                        {profile?.fullName ||
                  ...
                  {m.role === "user" && (
                    <div
                      className={cn(
                        "w-9 h-9 sm:w-10",
                        "sm:h-10 shrink-0 rounded-2xl",
                        "bg-[#2B4C3B] border border-[#2B4C3B]/30",
                        "flex items-center justify-center",
                        "text-white font-black text-xs",
                        "sm:text-sm shadow-sm overflow-hidden",
                        "sticky top-20 z-10",
                      )}
                    >
                      {profile?.avatarUrl ? (
      ...
      <div
        className={cn(
          ...
          "right-0 z-30 pointer-events-none",
          "pb-3 sm:pb-4 pt-4",
          "bg-gradient-to-t from-[#F8F6F0] via-[#F8F6F0]/95",
          "to-transparent",
        )}
      >
        <div
          className={cn(
            ...
            "px-4 sm:px-6 pointer-events-auto",
          )}
        >
          ...
          <form
            onSubmit={onSubmit}
            className={cn(
              "bg-white text-[#1C241E] p-3",
              "sm:p-4 rounded-3xl sm:rounded-[2rem]",
              "shadow-xl border border-[#E8E3D2]",
              "relative overflow-hidden transition-all",
              "focus-within:border-[#2B4C3B] focus-within:ring-2 focus-within:ring-[#2B4C3B]/10",
            )}
          >
            {/* Input Textarea */}
            <textarea
              ...
              className={cn(
                ...
                "text-[#1C241E] text-xs sm:text-sm",
                "font-medium focus:outline-none focus:ring-0",
                "resize-none placeholder:text-[#7A8678] leading-relaxed",
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    "bg-[#F8F6F0] hover:bg-[#EEF2E6] text-[#2B4C3B]",
                    "text-[11px] font-bold px-3",
                    "py-1.5 rounded-full transition-colors",
                    "border border-[#E8E3D2] cursor-pointer",
                    "active:scale-95",
                  )}
                >
                  <Paperclip
                ...
                {messages.length > 0 && (
                  <button
                    ...
                    className={cn(
                      "inline-flex items-center gap-1.5",
                      "bg-[#F8F6F0] hover:bg-red-50 text-[#7A8678]",
                      "hover:text-red-600 text-[11px] font-bold",
                      "px-3 py-1.5 rounded-full",
                      "transition-colors border border-[#E8E3D2]",
              ...
              <button
                ...
                className={cn(
                  "w-8.5 h-8.5 sm:w-9",
                  "sm:h-9 rounded-full bg-[#2B4C3B]",
                  "hover:bg-[#1E362A] text-white flex",
                  "items-center justify-center shadow-md",
                  "transition-all disabled:opacity-30 disabled:hover:bg-[#2B4C3B]",
          ...
          >
            ...
            <motion.div
              ...
              className={cn(
                ...
                "rounded-3xl p-6 max-w-sm",
                "w-full border border-[#E8E3D2]",
            ...
            >
              <div
                className={cn(
                  ...
                  "bg-red-50 text-red-600 flex",
                  "items-center justify-center mx-auto",
                  "mb-3 border border-red-100",
                  "shadow-sm",
                )}
              >
                <Trash2 size={24} />
              ...
              <p
                className={cn(
                  "text-xs text-[#5A635B] font-medium",
                  "leading-relaxed mb-6",
                )}
              >
                Seluruh percakapan Anda
                dengan Pranata Intelligence
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className={cn(
                    "flex-1 bg-[#F8F6F0] hover:bg-[#EEF2E6]",
                    "text-[#1C241E] font-extrabold text-xs",
      ...
      <footer
        className={cn(
          ...
          "text-[#7A8678] tracking-wider uppercase",
          "shrink-0",
        )}
      >
