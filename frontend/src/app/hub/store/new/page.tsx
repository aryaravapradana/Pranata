              ...
              return (
                ...
                >
                  <button
                    ...
                    form="productForm"
                    disabled={isDisabled}
                    className={`w-full py-4 sm:py-5 text-base sm:text-lg font-bold text-[#F8F6F0] rounded-full transition-all duration-200 transform-gpu flex items-center justify-center gap-3 cursor-pointer border border-white/10 ${
                      isDisabled
