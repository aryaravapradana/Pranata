...
export default function EditProductPage() {
  ...
  const [stepperStep, setStepperStep] =
    useState(2); // Start at step 2 for edit
                    ...
                    (() => {
                      ...
                      return (
                        <motion.div
                          ...
                          className={`mt-4 p-4 rounded-2xl overflow-hidden shadow-sm border-2 ${gradeStyle.bg} ${gradeStyle.border}`}
                        >
                          <div className="flex items-center justify-between mb-2">
                            <h3
                              className={`text-xs sm:text-sm font-black flex items-center gap-1.5 ${gradeStyle.text}`}
                            >
                              <ShieldCheck
                                size={16}
                              />
                            ...
                            <span
                              className={`text-[10px] sm:text-xs font-black uppercase ${gradeStyle.badgeBg} ${gradeStyle.badgeText} px-2.5 py-0.5 sm:px-3 sm:py-1 rounded-full shadow-sm flex items-center gap-1`}
                            >
                              <GradeIconComponent
                                size={12}
                                fill="currentColor"
                    ...
                    <div className="sm:col-span-1">
                      ...
                      <div className="relative">
                        ...
                        >
                          ...
                          <svg
                            className={`fill-current h-4 w-4 sm:h-5 sm:w-5 text-[#5A635B] transition-transform duration-200 ${showUnitDropdown ? "rotate-180" : ""}`}
                          ...
                          {showUnitDropdown && (
                            <motion.div
                              ...
                              className={cn(
                                ...
                                "border-[#DDE2D6] rounded-xl sm:rounded-2xl",
                                "shadow-xl overflow-hidden py-1.5",
                                "sm:py-2",
                              )}
                            >
                              {[
          ...
          {(() => {
            ...
            return (
              <div
                className={cn(
                  "px-4 py-4 md:px-12",
                  "md:py-8 border-t border-[#E8E3D2]",
                  "bg-[#F8F6F0] flex gap-3",
                )}
              >
                <button
                  type="submit"
